...
class TrainsetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for id in range(0, num):
            ...
            lr_y = rgb2y(lr)
            LR.append(lr_y)
            hr = Image.open(hr_dir + '/hr' + str(idx_frame + id) + '.png')
...
class TestsetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        num = self.frame_num
        LR_list = []
        LR0 = Image.open(dir + '/' + 'lr' + str(idx + 1) + '.png')
        LR1 = Image.open(dir + '/' + 'lr' + str(idx + 2) + '.png')
        LR2 = Image.open(dir + '/' + 'lr' + str(idx + 3) + '.png')
        LR3 = Image.open(dir + '/' + 'lr' + str(idx + 4) + '.png')
        LR4 = Image.open(dir + '/' + 'lr' + str(idx + 5) + '.png')
